...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/litao/Documents/av/FFmpeg/mac --enable-gpl --enable-nonfree --enable-libass --enable-libfdk-aac --enable-libfreetype --enable-libmp3lame --enable-libtheora --enable-libvorbis --enable-libvpx --enable-libx264 --enable-libx265 --enable-libopus --enable-libxvid --samples=fate-suite --extra-ldflags='-L/usr/local/lib     -L/usr/local/Cellar/libogg/1.3.3/lib     -L/usr/local/Cellar/theora/1.1.1/lib     -L/usr/local/Cellar/libvorbis/1.3.6/lib' --extra-cflags='-I/usr/local/include     -I/usr/local/Cellar/libogg/1.3.3/include     -I/usr/local/Cellar/theora/1.1.1/include     -I/usr/local/Cellar/libvorbis/1.3.5/include'
prefix=/Users/litao/Documents/av/FFmpeg/mac
...
CC_IDENT=Apple LLVM version 10.0.0 (clang-1000.11.45.5)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-I/usr/local/opt/icu4c/include -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC -DZLIB_CONST
CFLAGS=  -I/usr/local/include -I/usr/local/Cellar/libogg/1.3.3/include -I/usr/local/Cellar/theora/1.1.1/include -I/usr/local/Cellar/libvorbis/1.3.5/include -std=c11 -fomit-frame-pointer -fPIC -pthread -I/usr/local/Cellar/libass/0.14.0_1/include -I/usr/local/Cellar/harfbuzz/2.3.1/include/harfbuzz -I/usr/local/Cellar/glib/2.60.0_1/include/glib-2.0 -I/usr/local/Cellar/glib/2.60.0_1/lib/glib-2.0/include -I/usr/local/opt/gettext/include -I/usr/local/Cellar/pcre/8.43/include -I/usr/local/Cellar/graphite2/1.3.13/include -I/usr/local/Cellar/fribidi/1.0.5/include/fribidi -I/usr/local/opt/freetype/include/freetype2 -I/usr/local/Cellar/fdk-aac/2.0.0/include -I/usr/local/opt/freetype/include/freetype2 -I/usr/local/Cellar/opus/1.3/include/opus -I/usr/local/Cellar/libvpx/1.8.0/include -I/usr/local/Cellar/libvpx/1.8.0/include -I/usr/local/Cellar/libvpx/1.8.0/include -I/usr/local/Cellar/libvpx/1.8.0/include -I/usr/local/Cellar/x264/r2854/include -I/usr/local/Cellar/x265/2.9/include -D_THREAD_SAFE -I/usr/local/include/SDL2 -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/usr/local/include -I/usr/local/Cellar/libogg/1.3.3/include -I/usr/local/Cellar/theora/1.1.1/include -I/usr/local/Cellar/libvorbis/1.3.5/include -fPIC -g -Qunused-arguments
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS=-L/usr/local/opt/icu4c/lib -L/usr/local/lib -L/usr/local/Cellar/libogg/1.3.3/lib -L/usr/local/Cellar/theora/1.1.1/lib -L/usr/local/Cellar/libvorbis/1.3.6/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-liconv -L/usr/local/lib -lSDL2 -lxvidcore -L/usr/local/Cellar/x265/2.9/lib -lx265 -L/usr/local/Cellar/x264/r2854/lib -lx264 -L/usr/local/Cellar/libvpx/1.8.0/lib -lvpx -lm -L/usr/local/Cellar/libvpx/1.8.0/lib -lvpx -lm -L/usr/local/Cellar/libvpx/1.8.0/lib -lvpx -lm -L/usr/local/Cellar/libvpx/1.8.0/lib -lvpx -lm -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -L/usr/local/Cellar/opus/1.3/lib -lopus -lmp3lame -L/usr/local/opt/freetype/lib -lfreetype -L/usr/local/Cellar/fdk-aac/2.0.0/lib -lfdk-aac -L/usr/local/Cellar/libass/0.14.0_1/lib -lass -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
